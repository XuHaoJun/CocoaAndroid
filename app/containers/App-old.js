    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          onPress={this.onPressDrawerItem.bind(this, 'Omino IDE')}>
        ...
        <TouchableOpacity
          style={styles.drawerContent}
          onPress={this.onPressDrawerItem.bind(this, 'Device Manager')}>
          <Text style={styles.drawerText}>
            Device Manager
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.drawerContent}
          onPress={this.onPressDrawerItem.bind(this, 'About')}>
          <Text style={styles.drawerText}>
            About
          </Text>
        </TouchableOpacity>
